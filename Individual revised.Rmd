...
3m,The original graph does not include the population factor, so I used tableau inside data and generated another map graph, we can easily observe that there is a strong correlation between the number of people get hurt and the population in that state. 
